    ...
    <section id='home' className="section-hero">
        <div className="container py-[5%] px-8 lg:px-16 flex min-h-[90vh] h-full">
            <div className='mt-auto w-[70%] space-y-5'>
                ...
                <p className='text-lg'>Robolytics LLC stands out with proprietary frameworks that allow us to optimize LLMs for specific domains, significantly reducing costs and enhancing system performance.</p>
            </div>
            <div></div>
        </div>
    </section>
