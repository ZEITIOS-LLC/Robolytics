  ...
  return (
    <section id='about' className="bg-[url('/assets/geo-data.png')] bg-no-repeat bg-cover bg-center">
        <div className="container mx-auto flex flex-col relative py-[5%] px-8 lg:px-0 min-h-screen">
          <div className='lg:absolute top-[5%] left-0 space-y-5'>
            <span className='text-3xl sm:text-4xl md:text-8xl font-[900] tracking-[0.15em] opacity-5'>ROBOLYTICS</span>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-[700] font-poppins tracking-wide">FUTURE IS NOW</h2>
            <h2 className='text-primary text-lg md:text-xl font-bold uppercase w-fit'><span className='border-b-4 border-primary pb-2 lg:pb-5'>About</span> Robolytics</h2>
          </div>
          <div className='mt-auto pt-[10%] flex flex-col lg:flex-row justify-between space-y-3'>
            <div className='lg:w-[35%]'>
              ...
              <Image 
                ...
                height={0} 
                width={900}
                className="lg:h-60 w-full mt-5"
              />
            </div>
            <p className='font-medium lg:w-[35%] lg:bg-white/20 p-5 rounded lg:backdrop-blur-sm'>
